...
-- CreateIndex
CREATE UNIQUE INDEX "StudentCourse_id_student_id_course_key" ON "StudentCourse"("id_student", "id_course");
...
-- AddForeignKey
ALTER TABLE "Appointment" ADD CONSTRAINT "Appointment_id_semester_fkey" FOREIGN KEY ("id_semester") REFERENCES "Semester"("id_semester") ON DELETE RESTRICT ON UPDATE CASCADE;
